...
# =============================================================================
# SECTION 1: BROWSE STRUCTURE (uses global context)
# =============================================================================
...
if context['root_path']:
    ...
    st.header("1. Browse Test Structure")
    ...
    # =============================================================================
    # SECTION 2: INGEST NEW TEST
    # =============================================================================

    st.header("2. Ingest New Test")
    ...
    with col1:
        ...
        if not ing_system:
            st.caption("Select a system above")
        ...
        if not ing_campaign_id:
            st.caption("Select a campaign above")
